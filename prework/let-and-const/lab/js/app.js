...
function displayPics(){
  ...
  // The scope of `let rando` is limited to the block it was declared in, which is the the while loop. Thus, we cannot use this variable anywhere outside that scope. Unlike `var` that defines the variable to an entire function regardless of block scope.
  console.log(viewed);
